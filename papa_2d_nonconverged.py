...
mass_flux = False
context = get_context(model_version, "papa")
...
if model_version == AOSCMVersion.ECE3:
    ...
    ensemble_directory = context.output_dir / "ensemble_output_43_nc"
    start_dates = [
        pd.Timestamp("2014-07-07 06:00:00"),
        pd.Timestamp("2014-07-07 18:00:00"),
        pd.Timestamp("2014-07-09 06:00:00"),
        pd.Timestamp("2014-07-10 18:00:00"),
        pd.Timestamp("2014-07-11 18:00:00"),
        pd.Timestamp("2014-07-17 06:00:00"),
        pd.Timestamp("2014-07-18 06:00:00"),
        pd.Timestamp("2014-07-19 00:00:00"),
        pd.Timestamp("2014-07-23 06:00:00"),
        pd.Timestamp("2014-07-24 18:00:00"),
        pd.Timestamp("2014-07-26 12:00:00"),
        pd.Timestamp("2014-07-28 18:00:00"),
    ]
else:
    ensemble_directory = context.output_dir / "ensemble_output_nc"
    start_dates = [
        pd.Timestamp('2014-07-11 12:00:00'), 
        pd.Timestamp('2014-07-24 18:00:00'), 
        pd.Timestamp('2014-07-18 06:00:00'), 
        pd.Timestamp('2014-07-14 18:00:00'), 
        pd.Timestamp('2014-07-23 00:00:00'),
    ]
